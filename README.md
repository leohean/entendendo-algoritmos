...
## Algoritmos gulosos
Os algoritmos gulosos são aqueles que tentam realizar o melhor movimento a cada novo passo a fim de obter o melhor resultado. 

Por exemplo, sabemos que pelo Brasil há milhares de estações de rádio espalhadas pelo território, e agora nós precisamos descobrir o número mínimo de estações que consegue cobrir todo o país.
Essa é uma tarefa complexa, porque diversas dessas estações sobrepõe as áreas uma das outras. Uma alternativa para isso é utilizar a abordagem gulosa, no qual em cada movimento nós pegamos o maior número de estações que abrange uma área que ainda não cobrimos.

### Conjuntos
Um conjunto, ou *set* do inglês, funciona como uma lista, exceto pelo fato que ele não aceita elementos repetidos.
